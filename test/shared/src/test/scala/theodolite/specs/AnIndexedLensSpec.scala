...
import theodolite.internal.{Indexed, Shop}
import theodolite.law.discipline._
import theodolite.specs.compose._
import theodolite.{ALens, APrism, ATraversal, AffineTraversal, AnAffineTraversal, AnIndexedLens, AnIso, Iso, Lens, Prism, Traversal}

class AnIndexedLensSpec extends TheodoliteSuite {
