...
import theodolite.{ALens, APrism, ATraversal, AffineTraversal, AnAffineTraversal, AnIso, Fold, Getter, IndexedGetter, Iso, Lens, Prism, Traversal}

class IndexedGetterSpec extends TheodoliteSuite {
