...
import theodolite.instances.fields._
import theodolite.instances.partsOf._
import theodolite.law.discipline._
...
import theodolite.{ATraversal, ATraversal_, Getter, IndexedGetter, Iso, Lens, Lens_, Prism, Traversal, Traversal_}

class LensSpec extends TheodoliteSuite {
