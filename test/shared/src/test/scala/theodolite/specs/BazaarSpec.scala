...
import theodolite.internal.{Bazaar, RunBazaar}
import theodolite.law.discipline.{ChoiceTests, WanderTests}
import theodolite.profunctor.{Choice, Wander}

class BazaarSpec extends TheodoliteSuite {
