...
import theodolite.specs.Whole._
import theodolite.specs.compose._
import theodolite.{ALens, APrism, AffineTraversal, AnAffineTraversal, AnIso, Grate, IndexedSetter, Iso, Lens, Prism, Setter, Traversal}

class IndexedSetterSpec extends TheodoliteSuite {
