...
import theodolite.internal.{Forget, Re}
import theodolite.law.discipline.{ChoiceTests, CochoiceTests}
import theodolite.profunctor.{Choice, Cochoice}

class ReSpecs extends TheodoliteSuite {
