...
import theodolite.data._
import theodolite.syntax.function._
import theodolite.syntax.tuple._

private[theodolite] trait IndexedFold0[I, S, A] extends IndexedGetter0[I, S, A] with FoldInstances {
  ...
  private[theodolite] def minMax(s: S)(f: (A, A) => A): Option[A] =
