...
import theodolite.profunctor.Costar._
import theodolite.profunctor.Wander._
import theodolite.profunctor.{Costar, Star}
import theodolite.rank2types.{LensLikeWithIndex, Rank2TypeIndexedLensLike}
...
abstract class IndexedLens_[I, S, T, A, B] extends IndexedLens0[I, S, T, A, B] { self =>
  private[theodolite] def apply[P[_, _]](indexed: Indexed[P, I, A, B])(implicit ev: Strong[P]): P[S, T]
  ...
  final def reindex[J](f: I => J): IndexedLens_[J, S, T, A, B] = new IndexedLens_[J, S, T, A, B] {
    override private[theodolite] def apply[P[_, _]](indexed: Indexed[P, J, A, B])(implicit ev: Strong[P]): P[S, T] =
      self(indexed.reindex[I](f)(ev))
  }

  /** transform an [[IndexedLens_]] to a [[Lens_]] */
  final def asLens: Lens_[S, T, A, B] = new Lens_[S, T, A, B] {
    override private[theodolite] def apply[P[_, _]](pab: P[A, B])(implicit ev: Strong[P]): P[S, T] =
  ...
  final def asIndexedFold: IndexedFold_[I, S, T, A, B] = new IndexedFold_[I, S, T, A, B] {
    override private[theodolite] def apply[R: Monoid](indexed: Indexed[Forget[R, *, *], I, A, B]): Forget[R, S, T] =
  ...
  final def andThen[C, D](other: Getter_[A, B, C, D]): IndexedGetter_[I, S, T, C, D] = new IndexedGetter_[I, S, T, C, D] {
    override private[theodolite] def apply(indexed: Indexed[Forget[(C, I), *, *], I, C, D]): Forget[(C, I), S, T] =
      Forget { s =>
        val (a, i) = self.view(s)
  ...
  final def compose[C, D](other: Getter_[C, D, S, T]): IndexedGetter_[I, C, D, A, B] = new IndexedGetter_[I, C, D, A, B] {
    override private[theodolite] def apply(indexed: Indexed[Forget[(A, I), *, *], I, A, B]): Forget[(A, I), C, D] =
  ...
  final def andThenWithRightIndex[J, C, D](other: IndexedLens_[J, A, B, C, D]): IndexedLens_[J, S, T, C, D] = new IndexedLens_[J, S, T, C, D] {
    override private[theodolite] def apply[P[_, _]](indexed: Indexed[P, J, C, D])(implicit ev: Strong[P]): P[S, T] =
  ...
  final def andThenWithRightIndex[J, C, D](other: IndexedSetter_[J, A, B, C, D]): IndexedSetter_[J, S, T, C, D] = new IndexedSetter_[J, S, T, C, D] {
    override private[theodolite] def apply(indexed: Indexed[* => *, J, C, D]): S => T =
  ...
  final def andThenWithRightIndex[J, C, D](other: IndexedGetter_[J, A, B, C, D]): IndexedGetter_[J, S, T, C, D] = new IndexedGetter_[J, S, T, C, D] {
    override private[theodolite] def apply(indexed: Indexed[Forget[(C, J), *, *], J, C, D]): Forget[(C, J), S, T] =
  ...
  final def andThenWithRightIndex[J, C, D](other: IndexedFold_[J, A, B, C, D]): IndexedFold_[J, S, T, C, D] = new IndexedFold_[J, S, T, C, D] {
    override private[theodolite] def apply[R: Monoid](indexed: Indexed[Forget[R, *, *], J, C, D]): Forget[R, S, T] =
...
object IndexedLens_ {
  ...
  private[theodolite] def apply[I, S, T, A, B](f: Rank2TypeIndexedLensLike[I, S, T, A, B]): IndexedLens_[I, S, T, A, B] = new IndexedLens_[I, S, T, A, B] {
  ...
  private[theodolite] def liftIndexedOptic[P[_, _], I, S, T, A, B](to: S => ((A, I), B => T))(implicit ev: Strong[P]): P[(A, I), B] => P[S, T] =
