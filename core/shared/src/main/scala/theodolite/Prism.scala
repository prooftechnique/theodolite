...
import theodolite.IndexedTraversal_.wander
import theodolite.data.Disj
import theodolite.internal._
import theodolite.profunctor.{Choice, Star, Wander}
import theodolite.rank2types.{LensLikeWithIndex, Rank2TypePrismLike}
...
abstract class Prism_[S, T, A, B] extends Prism0[S, T, A, B] { self =>
  private[theodolite] def apply[P[_, _]](pab: P[A, B])(implicit ev: Choice[P]): P[S, T]
  ...
  final def asFold: Fold_[S, T, A, B] = new Fold_[S, T, A, B] {
    override private[theodolite] def apply[R: Monoid](forget: Forget[R, A, B]): Forget[R, S, T] =
  ...
  final def andThen[C, D](other: Iso_[A, B, C, D]): Prism_[S, T, C, D] = new Prism_[S, T, C, D] {
    override private[theodolite] def apply[P[_, _]](pab: P[C, D])(implicit ev: Choice[P]): P[S, T] = self(other(pab))
  ...
  final def compose[C, D](other: Iso_[C, D, S, T]): Prism_[C, D, A, B] = new Prism_[C, D, A, B] {
    override private[theodolite] def apply[P[_, _]](pab: P[A, B])(implicit ev: Choice[P]): P[C, D] = other(self(pab))
  ...
  final def andThen[C, D](other: Lens_[A, B, C, D]): AffineTraversal_[S, T, C, D] = new AffineTraversal_[S, T, C, D] {
    override private[theodolite] def apply[P[_, _]](pab: P[C, D])(implicit ev0: Choice[P], ev1: Strong[P]): P[S, T] = self(other(pab))
  ...
  final def compose[C, D](other: Lens_[C, D, S, T]): AffineTraversal_[C, D, A, B] = new AffineTraversal_[C, D, A, B] {
    override private[theodolite] def apply[P[_, _]](pab: P[A, B])(implicit ev0: Choice[P], ev1: Strong[P]): P[C, D] = other(self(pab))
  ...
  final def andThen[C, D](other: APrism_[A, B, C, D]): APrism_[S, T, C, D] = new APrism_[S, T, C, D] {
    override private[theodolite] def apply(market: Market[C, D, C, D]): Market[C, D, S, T] = self(other(market))
  ...
  final def compose[C, D](other: APrism_[C, D, S, T]): APrism_[C, D, A, B] = new APrism_[C, D, A, B] {
    override private[theodolite] def apply(market: Market[A, B, A, B]): Market[A, B, C, D] =
  ...
  final def andThen[C, D](other: Traversal_[A, B, C, D]): Traversal_[S, T, C, D] = new Traversal_[S, T, C, D] {
    override private[theodolite] def apply[P[_, _]](pab: P[C, D])(implicit ev: Wander[P]): P[S, T] = self(other(pab))
  }
  ...
  final def compose[C, D](other: Traversal_[C, D, S, T]): Traversal_[C, D, A, B] = new Traversal_[C, D, A, B] {
    override private[theodolite] def apply[P[_, _]](pab: P[A, B])(implicit ev: Wander[P]): P[C, D] = other(self(pab))
  }
    ...
    override def apply[F[_]](pafb: A => F[B])(c: C)(implicit ev: Applicative[F]): F[D] = {
      val bazaar: Bazaar[* => *, S, T, C, D] = other(new Bazaar[* => *, S, T, S, T] {
        override def runBazaar: RunBazaar[* => *, S, T, S, T] = new RunBazaar[* => *, S, T, S, T] {
          override def apply[G[_]](pafb: S => G[T])(s: S)(implicit ev: Applicative[G]): G[T] = pafb(s)
        }
      })
  ...
  final def andThen[C, D](other: Getter_[A, B, C, D]): Fold_[S, T, C, D] = new Fold_[S, T, C, D] {
    override private[theodolite] def apply[R: Monoid](forget: Forget[R, C, D]): Forget[R, S, T] =
  ...
  final def compose[C, D](other: Getter_[C, D, S, T]): Fold_[C, D, A, B] = new Fold_[C, D, A, B] {
    override private[theodolite] def apply[R: Monoid](forget: Forget[R, A, B]): Forget[R, C, D] =
  ...
  final def andThen[C, D](other: Fold_[A, B, C, D]): Fold_[S, T, C, D] = new Fold_[S, T, C, D] {
    override private[theodolite] def apply[R: Monoid](forget: Forget[R, C, D]): Forget[R, S, T] = self(other(forget))
  }
  ...
  final def compose[C, D](other: Fold_[C, D, S, T]): Fold_[C, D, A, B] = new Fold_[C, D, A, B] {
    override private[theodolite] def apply[R: Monoid](forget: Forget[R, A, B]): Forget[R, C, D] = other(self(forget))
  }
  ...
  final def andThen[C, D](other: Review_[A, B, C, D]): Review_[S, T, C, D] = new Review_[S, T, C, D] {
    override private[theodolite] def apply(tagged: Tagged[C, D]): Tagged[S, T] = self(other(tagged))
  }
  ...
  final def compose[C, D](other: Review_[C, D, S, T]): Review_[C, D, A, B] = new Review_[C, D, A, B] {
    override private[theodolite] def apply(tagged: Tagged[A, B]): Tagged[C, D] = other(self(tagged))
  }
  ...
  final def compose[I, C, D](other: IndexedSetter_[I, C, D, S, T]): IndexedSetter_[I, C, D, A, B] = new IndexedSetter_[I, C, D, A, B] {
    override private[theodolite] def apply(indexed: Indexed[Function, I, A, B]): C => D =
  ...
  final def andThen[I, C, D](other: IndexedGetter_[I, A, B, C, D]): IndexedFold_[I, S, T, C, D] = new IndexedFold_[I, S, T, C, D] {
    override private[theodolite] def apply[R: Monoid](indexed: Indexed[Forget[R, *, *], I, C, D]): Forget[R, S, T] =
  ...
  final def compose[I, C, D](other: IndexedGetter_[I, C, D, S, T]): IndexedFold_[I, C, D, A, B] = new IndexedFold_[I, C, D, A, B] {
    override private[theodolite] def apply[R: Monoid](indexed: Indexed[Forget[R, *, *], I, A, B]): Forget[R, C, D] =
      Forget { c =>
...
object Prism_ {
  ...
  private[theodolite] def apply[S, T, A, B](prismLike: Rank2TypePrismLike[S, T, A, B] with PrismFunctions[S, T, A]): Prism_[S, T, A, B] = new Prism_[S, T, A, B] { self =>
