...
import theodolite.Traversal.both
import theodolite.instances.field1._
import theodolite.instances.index.{index, _}
import theodolite.instances.traverseWithIndex._
import theodolite.specs.TheodoliteSuite
import theodolite.std.tuple._1
import theodolite.syntax.indexedFold._
import theodolite.{IndexedFold, IndexedFold_, IndexedLens}

class IndexedFoldExamples extends TheodoliteSuite {
